...
# Changed max growth rate from 1.0 to 2.0
R = 2.0  
# Changed boundary condition from 1.0 to 0.5
ft0 = 0.5 
...
ax.set(title="Logistic equation solved with NNs (R=2.0, ft0=0.5)", xlabel="t", ylabel="f(t)")
ax.legend()
# Save before showing
fig.savefig('pinn_task3_changed_params.png', dpi=300, bbox_inches='tight')
plt.show() 