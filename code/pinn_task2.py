...
ax.set(title="Logistic equation solved with NNs (No PDE Loss)", xlabel="t", ylabel="f(t)")
ax.legend()
# Save before showing
fig.savefig('pinn_task2_no_pde.png', dpi=300, bbox_inches='tight')
plt.show() 